...
class AppConstants {
  ...
  static String get apiBaseUrl =>
      dotenv.maybeGet('API_BASE_URL') ?? 'https://convenz.onrender.com/api/v1';
  ...
  static String get apiSigningSecret =>
      dotenv.maybeGet('API_SIGNING_SECRET') ?? 'convenz_default_secret_key_2024_@!';
}
